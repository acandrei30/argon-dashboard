...
urlpatterns = [
    ...
    path("caregiver/<int:caregiver_id>/add-notes/", views.add_notes, name="recruitment-add-notes"),
    path("hello_companion/", views.hello_companion, name="hello_companion"),  # Public form
